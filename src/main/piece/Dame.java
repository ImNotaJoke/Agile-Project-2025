...
public class Dame extends Piece {
    ...
    public boolean move(Plateau plateau, int[] oldPosition, int[] newPosition) {
        ...
        if (moveIsOk(plateau.getPlateau(), oldPosition, newPosition) && newPosition != oldPosition && plat[newPosition[0]][newPosition[1]] != null && plat[newPosition[0]][newPosition[1]].getColor() != this.getColor()) {
